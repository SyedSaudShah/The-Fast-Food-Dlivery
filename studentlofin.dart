                ...
                children: [
                  ...
                  ElevatedButton(onPressed: () {
                    // if (emailGlobalKey.currentState!.validate()  &&passwordGlobalKey.currentState!.validate()) {
                       signInBloc.add(FetchsigninEvent(email.text.trim(), password.text.trim()));
                    // }
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                        ...
                        child: Row(
                          children: [
                            Image.asset(height: 20, 'lib/assetsimg/google.png'),
                            SizedBox(width: (myWidth / 1.5) / 7,),
...
class SignInPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Scaffold(body: Stack(children:  [const Studentlogin(),
